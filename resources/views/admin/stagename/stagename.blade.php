                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <strong class="card-title">Blog StageNames</strong>
                            <a href="{{ route('stagename.add') }}" class="btn btn-success btn-sm">Add +</a>
                        </div>

                        <div class="card-body">
                            <table id="stagename-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Status</th>
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td align="right">
                                                ...
                                                <a href="{{ route('stagename.delete', ['id' => $row['id']]) }}"
