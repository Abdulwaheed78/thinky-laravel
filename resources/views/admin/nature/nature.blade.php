                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <strong class="card-title">Blog Natures</strong>
                            <a href="{{ route('nature.add') }}" class="btn btn-success btn-sm">Add +</a>
                        </div>

                        <div class="card-body">
                            <table id="nature-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Status</th>
                                ...
                                <tbody>
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row['status'] }}</td>
                                            <td align="right">
                                                <a href="{{ route('nature.edit', ['id' => $row['id']]) }}"
                                                    class="btn btn-outline-secondary btn-sm"><i class="fa fa-edit"></i></a>

                                                <a href="{{ route('nature.delete', ['id' => $row['id']]) }}"
